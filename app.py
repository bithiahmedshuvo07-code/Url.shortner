...
# Render normally provides RENDER.
IS_PRODUCTION = (
...
app.config.update(
    ...
    PERMANENT_SESSION_LIFETIME=__import__(
        "datetime"
    ).timedelta(days=7),
)
...
def current_user():
    ...
    try:
        ...
        # ADMIN_EMAIL also controls admin access.
...
<a
class="gold"
href="/analytics/{html.escape(short)}"
>
View A–Z
</a>
...
def redirect_short_link(short_code):
    ...
    try:
        ...
        # Do not block the destination if analytics
...
if __name__ == "__main__":
    ...
    print(
        "SMARTLINK · "
        "MULTI-USER + PRIVATE LINKS + ADMIN"
    )
